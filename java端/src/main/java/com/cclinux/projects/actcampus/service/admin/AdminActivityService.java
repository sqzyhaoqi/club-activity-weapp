...
//        appError("{校园活动}该功能暂不开放，如有需要请加作者微信：wxid_ly1r09e297e722");
        this.activityJoinMapper.delete(activityJoinId);
    }
    ...
    public void statusActivity(long id, int status) {
        ...
        uw.set("ACTIVITY_STATUS", status);
        this.activityMapper.edit(uw);
    }
